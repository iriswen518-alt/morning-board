...
from fetch_stocks import (  # noqa: E402
    fetch_finnhub_quote, fetch_yahoo_history, compute_mtd_ytd, UA,
)
...
STOCK_NAMES_ZH = {
    ...
    "AMZN": "亞馬遜", "META": "Meta", "NVDA": "輝達", "TSLA": "特斯拉",
    "ORCL": "甲骨文", "CRM": "Salesforce", "NOW": "ServiceNow",
    "ADBE": "Adobe", "PLTR": "Palantir", "SNOW": "Snowflake",
    "NET": "Cloudflare", "DDOG": "Datadog", "ZS": "Zscaler", "OKTA": "Okta",
    "PANW": "Palo Alto Networks", "CRWD": "CrowdStrike", "MDB": "MongoDB",
    "WDAY": "Workday", "INTU": "Intuit", "TEAM": "Atlassian",
    # Semiconductors
    "AMD": "超微", "AVGO": "博通", "INTC": "英特爾", "MU": "美光",
    "ASML": "ASML", "TSM": "台積電 ADR", "QCOM": "高通",
    "MRVL": "邁威爾", "NXPI": "恩智浦", "ARM": "Arm",
    "SMCI": "美超微", "LRCX": "科林研發", "AMAT": "應材", "KLAC": "科磊",
    # EV / Auto
    "RIVN": "Rivian", "LCID": "Lucid", "F": "福特", "GM": "通用",
    "NIO": "蔚來", "XPEV": "小鵬", "LI": "理想",
    # Fintech / Payments
    "PYPL": "PayPal", "SQ": "Block", "SOFI": "SoFi",
    "COIN": "Coinbase", "HOOD": "Robinhood",
    "V": "Visa", "MA": "萬事達", "AXP": "美國運通",
    # China ADRs
    "BABA": "阿里巴巴", "JD": "京東", "PDD": "拼多多", "BIDU": "百度",
    "TCOM": "攜程", "TME": "騰訊音樂",
    # Comms / Media / Consumer Internet
    "NFLX": "網飛", "DIS": "迪士尼", "RBLX": "Roblox",
    "SPOT": "Spotify", "T": "AT&T", "VZ": "威訊",
    "UBER": "Uber", "LYFT": "Lyft", "ABNB": "Airbnb", "DASH": "DoorDash",
    "SHOP": "Shopify", "ETSY": "Etsy", "PINS": "Pinterest",
    "SNAP": "Snap", "RDDT": "Reddit",
    # Energy / Materials
    "XOM": "艾克森美孚", "CVX": "雪佛龍", "NEE": "新時代能源",
    "OXY": "西方石油", "COP": "康菲石油", "FCX": "自由港麥克莫蘭",
    # Healthcare / Pharma / Biotech
    "LLY": "禮來", "JNJ": "嬌生", "PFE": "輝瑞", "MRK": "默克",
    "ABBV": "艾伯維", "REGN": "再生元", "MRNA": "莫德納",
    "UNH": "聯合健康", "CVS": "CVS Health", "GILD": "吉立亞",
    "VRTX": "Vertex",
    # Financials
    "JPM": "摩根大通", "BAC": "美國銀行", "GS": "高盛",
    "MS": "摩根士丹利", "WFC": "富國銀行", "C": "花旗",
    "BRK.B": "波克夏 B", "BLK": "貝萊德", "SCHW": "嘉信理財",
    # Consumer
    "COST": "好市多", "WMT": "沃爾瑪", "TGT": "標靶",
    "HD": "家得寶", "LOW": "羅威", "MCD": "麥當勞",
    "SBUX": "星巴克", "NKE": "Nike", "KO": "可口可樂",
    "PEP": "百事", "PG": "寶僑", "CL": "高露潔棕欖",
    # Industrials
    "BA": "波音", "CAT": "卡特彼勒", "GE": "奇異",
    "LMT": "洛馬", "RTX": "雷神", "DE": "強鹿",
    # Crypto-related
    "BKKT": "Bakkt", "MARA": "Marathon Digital", "RIOT": "Riot Platforms",
    "MSTR": "MicroStrategy", "CLSK": "CleanSpark",
    # Ad / Mar-tech
    "ZETA": "Zeta Global", "TTD": "The Trade Desk", "APP": "AppLovin",
}
...
def build_record(symbol, name_zh):
    ...
    rec["change_pct"] = round(change_pct, 2) if isinstance(change_pct, (int, float)) else change_pct
    # MTD/YTD（best-effort）
    hist = fetch_yahoo_history(symbol)
    if hist:
