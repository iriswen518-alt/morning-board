...
const LICAI_REF = {
  ...
  // 主題直接內容頁（官方／權威機構說明頁，點下去就是該概念；皆已實測 200，不用維基百科）
  d_compound:   "[🔗 複利說明（退撫基金）](https://www.fund.gov.tw/News_Content.aspx?n=3268&s=15185)",
  d_dca:        "[🔗 定期定額（退撫基金）](https://www.fund.gov.tw/News_Content.aspx?n=3268&s=15170)",
  d_etf:        "[🔗 ETF 總覽（證交所）](https://www.twse.com.tw/zh/products/securities/etf/overview/introduction.html)",
  d_alloc:      "[🔗 資產配置（退撫基金）](https://www.fund.gov.tw/News_Content.aspx?n=1862&s=14427)",
  d_diversify:  "[🔗 分散投資（退撫基金）](https://www.fund.gov.tw/News_Content.aspx?n=1862&s=14432)",
  ...
  d_yieldcurve: "[🔗 殖利率曲線（退撫基金）](https://www.fund.gov.tw/News_Content.aspx?n=708&s=16905)",
...
const LICAI_KB_REFS = {
  ...
  "gdp": [LICAI_REF.d_gdp],
  // ── 新增條目延伸參考 ──
  "財務自由": [LICAI_REF.academy],
  "理財第一步": [LICAI_REF.academy],
